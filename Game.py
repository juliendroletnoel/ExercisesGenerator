    ...
    def start_game(self):
        ...
        while choice != 0:
            ...
            if choice == 1:
                ...
                choices = self.__challenge_generator.generate_resources_challenges(3, Water, 'beast', 'chest', '')
                print()

                for i in range(1, 4):
                    print ('{} - {}'.format(i, choices[i-1].get_exercise_name()))
                print()
            ...
            if choice == 2:
                print ('2 Amasser de la nourriture')
                choices = self.__challenge_generator.generate_resources_challenges(3, Food, 'beginner', 'core', '')
                print()
            ...
            if choice == 3:
                print ('3 Construire un abris')
                choices = self.__challenge_generator.generate_resources_challenges(3, Water, 'beast', '', 'cardio')
                print()
